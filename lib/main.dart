...
class _MyAppState extends State<MyApp> {
  ...
  void initState() {
    ...
    userStream = recytecFirebaseUserStream()
        ...
        items: [
          ...
          FloatingNavbarItem(
            customWidget: Column(
              ...
              children: [
                Icon(
                  currentIndex == 1 ? Icons.local_play : Icons.local_police,
                  color:
            ...
            customWidget: Column(
              ...
              children: [
                Icon(
                  ...
                  color:
                      currentIndex == 3 ? Color(0xFF4B39EF) : Color(0x98939393),
                  size: 32.0,
                ),
              ],
            ),
            ...
            customWidget: Column(
              ...
              children: [
                Icon(
                  ...
                  color:
                      currentIndex == 4 ? Color(0xFF4B39EF) : Color(0x98939393),
                  size: 24.0,
                ),
              ],
            ),
