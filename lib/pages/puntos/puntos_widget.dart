...
import 'puntos_model.dart';
export 'puntos_model.dart';

class PuntosWidget extends StatefulWidget {
  const PuntosWidget({Key? key}) : super(key: key);
...
class _PuntosWidgetState extends State<PuntosWidget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PuntosModel());
                                            ...
                                            child: Padding(
                                              ...
                                              child: ClipRRect(
                                                borderRadius:
                                                    BorderRadius.circular(8.0),
                                                child: Image.asset(
                                                  'assets/images/boligrafo_(2).png',
                                                  width: 282.0,
                                                  height: 181.0,
                                                  fit: BoxFit.cover,
                                                ),
                                  ...
                                  Stack(
                                    ...
                                    children: [
                                      ...
                                      ClipRRect(
                                        ...
                                        child: Image.asset(
                                          'assets/images/943092_010_A.jpeg',
                                          width: 251.0,
                                          height: 200.0,
                                          fit: BoxFit.cover,
                                        ),
                              ...
                              children: [
                                        ...
                                        children: [
                                          ...
                                          ClipRRect(
                                            borderRadius:
                                                BorderRadius.circular(16.0),
                                            child: Image.asset(
                                              'assets/images/2065254770831_2.jpg',
                                              width: 251.0,
                                              height: 200.0,
                                              fit: BoxFit.cover,
                                            ),
                                ...
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      0.0, 0.0, 0.0, 8.0),
                                  child: Text(
                                    'AUDÍFONOS BLUETOOTH ON EAR SONY NEGRO WH1000XM4',
                                    style: FlutterFlowTheme.of(context)
                                        .headlineMedium
                                        .override(
                                          fontFamily: 'Outfit',
