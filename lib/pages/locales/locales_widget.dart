...
export 'locales_model.dart';

class LocalesWidget extends StatefulWidget {
  const LocalesWidget({Key? key}) : super(key: key);

  @override
  _LocalesWidgetState createState() => _LocalesWidgetState();
}

class _LocalesWidgetState extends State<LocalesWidget>
    with TickerProviderStateMixin {
  late LocalesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LocalesModel());
  }
                        ...
                        Align(
                          ...
                          child: Hero(
                            ...
                            child: ClipRRect(
                              ...
                              child: Image.asset(
                                'assets/images/Imagen_de_WhatsApp_2023-06-12_a_las_00.54.06.jpg',
                                width: double.infinity,
